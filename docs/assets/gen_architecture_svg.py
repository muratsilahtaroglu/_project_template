#!/usr/bin/env python3
"""Generate the README's data-driven diagrams (this dir) — same visual language, two maps:
...
Edit the GROUPS lists below and re-run (`python3 docs/assets/gen_architecture_svg.py`) when the
layout changes — no manual coordinate tweaking. Emits self-contained SVGs (own background, system
fonts, no external assets or scripts) so they render in both GitHub light & dark themes."""
import html
import os
